...
import CanvasJSModule from './canvasjs.stock.min';

var CanvasJS = CanvasJSModule && CanvasJSModule.Chart ? CanvasJSModule : (CanvasJSModule && CanvasJSModule.default ? CanvasJSModule.default : (typeof window !== 'undefined' ? window.CanvasJS : null));
