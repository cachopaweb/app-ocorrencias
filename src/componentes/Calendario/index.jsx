...
function Calendario() {
    ...
    return (
        <>
            ...
            <div className="w-screen h-screen mx-auto flex justify-start items-center flex-col">
                <div className="w-full">
                    <form id="form" className="m-[10px] w-full">
                        <div className="flex mb-[10px]">
                            <div className="p-[5px] text-[1rem]">
                                <label htmlFor="minhas_os" className="mb-[5px] block">Minhas Terefas</label>
                                <input type="radio" name="filtro" id="minhas_os" value={filtroEventos} onChange={() => setFiltroEventos('minhas_os')} checked={filtroEventos === 'minhas_os'} className="w-full text-[1.1em] my-[5px] h-[20px]" />
                            </div>
                            <div className="p-[5px] text-[1rem]">
                                <label htmlFor="todas" className="mb-[5px] block">Todas</label>
                                <input type="radio" name="filtro" id="todas" value={filtroEventos} onChange={() => setFiltroEventos('todas')} checked={filtroEventos === 'todas'} className="w-full text-[1.1em] my-[5px] h-[20px]" />
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div className="w-[60%]">
                    {carregando ?
                        <div className="mx-auto flex justify-center items-center">Carregando dados...</div>
                        :
                        <FullCalendar
