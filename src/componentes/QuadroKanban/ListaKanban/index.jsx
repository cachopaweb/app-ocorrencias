...
function ListaKanban({ data, listIndex }) {
  ...
  return (
    <div ref={ref} className="px-[15px] h-full flex-[0_0_400px] w-full [&+div]:border-l [&+div]:border-black/5">
      <header className="flex justify-center items-center h-[42px]">
        <h2 className="font-medium text-[16px] px-[10px]">{data.title}</h2>
        {listIndex === 0 && (
          <button className="w-[42px] h-[42px] rounded-[18px] bg-[#3b5bfd] border-0 cursor-pointer mb-[5px]" onClick={() => criarOcorrencia()}>
