                    ...
                    <form onSubmit={submitEstoria}>
                        ...
                        <div className="form-group">
                            ...
                            <div className="flex flex-row flex-wrap mt-4">
                                {
                                    files?.map(file =>
                                        <div className="inline-flex rounded-sm border border-[#eaeaea] mb-2 mr-2 w-[100px] h-[100px] p-1" onClick={() => abrirPreview(file)}>
                                            <div className="flex min-w-0 overflow-hidden">
                                                <img key={file.name} src={file.preview} className="block w-auto h-full" />
                                            </div>
                                        </div>
                                    )
                                }
